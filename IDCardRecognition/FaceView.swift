    ...
    override func draw(_ rect: CGRect) {
        ...
        if(faceResults_ != nil) {
            if(faceResults_!["Position"] != nil) {
                ...
                let score = (faceResults_!["Quality"] as! NSNumber).floatValue

                let left = (position["x1"] as! NSNumber).floatValue
                let top = (position["y1"] as! NSNumber).floatValue
                let right = (position["x2"] as! NSNumber).floatValue
                let bottom = (position["y2"] as! NSNumber).floatValue
